...
var AppComponent = /** @class */ (function () {
    function AppComponent(platform, splashScreen, statusBar, oneSignal, alertCtrl, router, toast, modalCtrl, menu, popoverCtrl, actionSheetCtrl) {
                ...
                switch (_a.label) {
                    ...
                    case 12:
                        this.routerOutlets.forEach(function (outlet) {
                            ...
                            else if (_this.router.url === '/home') {
                                if (new Date().getTime() - _this.lastTimeBackPress < _this.timePeriodToExit) {
                                    // this.platform.exitApp(); // Exit from app
                                    navigator['app'].exitApp(); // work in ionic 4
                                }
                                else {
                                    _this.toast.show("Press back again to exit App.", '2000', 'center')
...
/* harmony import */ var _moment_pipe__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./moment.pipe */ "./src/app/moment.pipe.ts");
...
module.exports = __webpack_require__(/*! /Users/ahayder/Work/shob-khobor/src/main.ts */"./src/main.ts");
